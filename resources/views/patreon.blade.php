...
<html lang="ua">
<head>
    @include('layouts.headpatreon', ['title' => 'InoZemeZ'])
...
<!-- ======= Header ======= -->
  ...
  <section id="hero">
    ...
    <div class="hero-text" data-aos="zoom-out">
      ...
      <a href="https://www.patreon.com/InoZemeZ" class="btn-get-started scrollto">Get Started</a>
    </div>
