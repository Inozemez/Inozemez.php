...
<head>
    ...
    <meta content="" name="Італія, квартира в п'ємонте, кімната в п'ємонте, місце - ліжко в п'ємонте, зняти квартиру в п'ємонте, зняти кімнату в п'ємонте, зняти місце - ліжко в п'ємонте.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні П'ємонт!</h1>
        </div>
      </div>
    </div>
