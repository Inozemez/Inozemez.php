...
<head>
    ...
    <meta content="" name="Італія, квартира в ломбардії, кімната в ломбардії, місце - ліжко в ломбардії, зняти квартиру в ломбардії, зняти кімнату в ломбардії, зняти місце - ліжко в ломбардії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Ломбардія!</h1>
        </div>
      </div>
    </div>
