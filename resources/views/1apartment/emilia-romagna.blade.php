...
<head>
    ...
    <meta content="" name="Італія, квартира в емілії-романьі, кімната в емілії-романьі, місце - ліжко в емілії-романьі, зняти квартиру в емілії-романьі, зняти кімнату в емілії-романьі, зняти місце - ліжко в емілії-романьі.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Емілія-Романья!</h1>
        </div>
      </div>
    </div>
