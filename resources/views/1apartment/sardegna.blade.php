...
<head>
    ...
    <meta content="" name="Італія, квартира в сардинії, кімната в сардинії, місце - ліжко в сардинії, зняти квартиру в сардинії, зняти кімнату в сардинії, зняти місце - ліжко в сардинії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Сардинія!</h1>
        </div>
      </div>
    </div>
