...
<head>
    ...
    <meta content="" name="Італія, квартира в молізе, кімната в молізе, місце - ліжко в молізе, зняти квартиру в молізе, зняти кімнату в молізе, зняти місце - ліжко в молізе.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Молізе!</h1>
        </div>
      </div>
    </div>
