...
<head>
    ...
    <meta content="" name="Італія, квартира в марке, кімната в марке, місце - ліжко в марке, зняти квартиру в марке, зняти кімнату в базилмаркеікаті, зняти місце - ліжко в марке.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Марке!</h1>
        </div>
      </div>
    </div>
