...
<head>
    ...
    <meta content="" name="Італія, квартира в лаціо, кімната в лаціо, місце - ліжко в лаціо, зняти квартиру в лаціо, зняти кімнату в лаціо, зняти місце - ліжко в лаціо.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Лаціо!</h1>
        </div>
      </div>
    </div>
