...
<head>
    ...
    <meta content="" name="Італія, квартира в апулії, кімната в апулії, місце - ліжко в апулії, зняти квартиру в апулії, зняти кімнату в апулії, зняти місце - ліжко в апулії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Апулія!</h1>
        </div>
      </div>
    </div>
