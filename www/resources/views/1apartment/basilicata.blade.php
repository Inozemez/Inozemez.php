...
<head>
   @include('layouts.head', ['title' => 'Житло в Італії-тут ви знайдете квартири, кімнати та інші варіанти проживання.'])
    ...
    <meta content="" name="Італія, квартира в базилікаті, кімната в базилікаті, місце - ліжко в базилікаті, зняти квартиру в базилікаті, зняти кімнату в базилікаті, зняти місце - ліжко в базилікаті.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Базиліката!</h1>
        </div>
      </div>
    </div>
