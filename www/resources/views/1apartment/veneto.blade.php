...
<head>
    ...
    <meta content="" name="Італія, квартира в венето, кімната в венето, місце - ліжко в венето, зняти квартиру в венето, зняти кімнату в венето, зняти місце - ліжко в венето.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Венето!</h1>
        </div>
      </div>
    </div>
