...
<head>
    ...
    <meta content="" name="Італія, квартира в тоскані, кімната в тоскані, місце - ліжко в тоскані, зняти квартиру в тоскані, зняти кімнату в тоскані, зняти місце - ліжко в тоскані.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Тоскана!</h1>
        </div>
      </div>
    </div>
