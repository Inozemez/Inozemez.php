...
<head>
    ...
    <meta content="" name="Італія, квартира в кампанії, кімната в кампанії, місце - ліжко в кампанії, зняти квартиру в кампанії, зняти кімнату в кампанії, зняти місце - ліжко в кампанії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Кампанія!</h1>
        </div>
      </div>
    </div>
