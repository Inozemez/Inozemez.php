...
<head>
    ...
    <meta content="" name="Італія, квартира в калабрії, кімната в калабрії, місце - ліжко в калабрії, зняти квартиру в калабрії, зняти кімнату в калабрії, зняти місце - ліжко в калабрії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Калабрія!</h1>
        </div>
      </div>
    </div>
