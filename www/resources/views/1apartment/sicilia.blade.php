...
<head>
    ...
    <meta content="" name="Італія, квартира в сицилії, кімната в сицилії, місце - ліжко в сицилії, зняти квартиру в сицилії, зняти кімнату в сицилії, зняти місце - ліжко в сицилії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Сицилія!</h1>
        </div>
      </div>
    </div>
