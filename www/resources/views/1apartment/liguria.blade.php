...
<head>
    ...
    <meta content="" name="Італія, квартира в лігурії, кімната в лігурії, місце - ліжко в лігурії, зняти квартиру в лігурії, зняти кімнату в лігурії, зняти місце - ліжко в лігурії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Лігурія!</h1>
        </div>
      </div>
    </div>
