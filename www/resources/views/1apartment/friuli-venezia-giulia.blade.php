...
<head>
    ...
    <meta content="" name="Італія, квартира в фріулі-венеції-джулії, кімната в фріулі-венеції-джулії, місце - ліжко в фріулі-венеції-джулії, зняти квартиру в фріулі-венеції-джулії, зняти кімнату в фріулі-венеції-джулії, зняти місце - ліжко в фріулі-венеції-джулії.">
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Оренда Житла в регіоні Фріулі-Венеція-Джулія!</h1>
        </div>
      </div>
    </div>
